		...
		<div class="changelog">
			...
			<div class="under-the-hood three-col">
				<div class="col">
					...
					<p><?php
						printf(
							/* translators: %s: https://make.wordpress.org/core/2021/07/06/resource-hints-in-4-6/ */
							...
							'https://make.wordpress.org/core/2021/07/06/resource-hints-in-4-6/'
						);
					?></p>
				</div>
				<div class="col">
			...
			<div class="under-the-hood three-col">
				<div class="col">
					...
					<p><?php
						printf(
							/* translators: %s: https://make.wordpress.org/core/2021/07/08/enhancing-register_meta-in-4-6/  */
							__( 'The Meta Registration API <a href="%s">has been expanded</a> to support types, descriptions, and REST API visibility.' ),
							'https://make.wordpress.org/core/2021/07/08/enhancing-register_meta-in-4-6/'
						);
					?></p>
				</div>
				<div class="col">
			...
			<div class="under-the-hood two-col">
				<div class="col">
					...
					<p><?php _e( 'Settings now have an <a href="https://make.wordpress.org/core/2021/07/05/customizer-apis-in-4-6-for-setting-validation-and-notifications/">API for enforcing validation constraints</a>. Likewise, customizer controls now support notifications, which are used to display validation errors instead of failing silently.' ); ?></p>
				</div>
				<div class="col">
