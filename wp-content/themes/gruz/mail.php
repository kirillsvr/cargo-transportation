 ...
 */
 ...
 <?php
  ...
  // make letter body
      $msg .= "<p><strong>Имя: </strong> ".$_POST['fio1']."</p>\r\n";
        if(isset($_POST['phone_1'])){
    $msg .= "<p><strong>Телефон: </strong> ".$_POST['phone_1']."</p>\r\n";
  }
  if(isset($_POST['adress_'])){
$msg .= "<p><strong>Адресс: </strong> ".$_POST['adress_']."</p>\r\n";
}
  $msg .= "</body></html>";
  // send message
