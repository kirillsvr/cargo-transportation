...
$(document).ready(function () {
  ...
  $('#calback_form_car').each(function () {
    var i = $(this);
    var dom = window.location.protocol;
    $(i).validate({
      rules: {
        fio1: {
          required: true
      ...
      submitHandler: function submitHandler(form) {
        ...
        $.ajax({
          type: 'POST',
          url: dom+'/wp-content/themes/gruz/mail.php',
          data: thisForm.serialize(),
  ...
  $('#calback_form').each(function () {
    ...
    $(i).validate({
      ...
      submitHandler: function submitHandler(form) {
        ...
        $.ajax({
          type: 'POST',
          url: dom+'/wp-content/themes/gruz/mail_order.php',
          data: thisForm.serialize(),
          success: function success(data) {
            $(thisForm).addClass('success');
            $(thisForm).trigger("reset");
  ...
  $('#calback_form_index').each(function () {
    ...
    $(i).validate({
      ...
      submitHandler: function submitHandler(form) {
        ...
        $.ajax({
          type: 'POST',
          url: dom+'/wp-content/themes/gruz/mail_calback.php',
          data: thisForm.serialize(),
          success: function success(data) {
            $(thisForm).addClass('success');
            $(thisForm).trigger("reset");
  ...
  $('#calback_form_tenancy').each(function () {
    ...
    $(i).validate({
      ...
      submitHandler: function submitHandler(form) {
        ...
        $.ajax({
          type: 'POST',
          url: dom+'/wp-content/themes/gruz/mail_tenancy.php',
          data: thisForm.serialize(),
          success: function success(data) {
            $(thisForm).addClass('success');
            $(thisForm).trigger("reset");
  ...
  $(".cranes_page_btn").click(function () {
    $(".calback_form_title").text($(this).parents(".filter_content_item").find(".filter_content_item_info").find(".filter_content_item_info-title").find("a").text());
