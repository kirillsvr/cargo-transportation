  ...
  <div class="container">
      <div class="breadcrumbs">
        <ul>
          ...
          <li><a href="<?php the_permalink(1904); ?>"><?php echo get_the_title(1904); ?></a></li>
            ...
            <div class="right_block">
              ...
              <div class="price_rent">
                ...
                <ul class="price_rent_list">
                  <li>Город - <?php echo $value["city"]; ?></li>
                  <li>Межгород - <span><?php echo $value["no_city"]; ?> р.</li>
                </ul>
                <?php } ?>
    ...
    <section class="our_review" style="margin-top: 40px">
      <div class="container">
