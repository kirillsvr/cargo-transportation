    ...
    <div class="container sale_page_wrap">
      ...
      <?php
        $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
         query_posts( array('post_type' => 'news','posts_per_page' => -1, 'paged'=>$paged, ) );
       while(have_posts()) : the_post(); ?>
      <div class="row sale_item">
        <div class="col-md-4 sale_item_imamge">
          <?php the_post_thumbnail(); ?>
        </div>
        <div class="col-md-8 sale_item_content">
          <div class="sale_item_content_title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></div>
          <p>
            <?php the_excerpt();?>
          </p>
          <div class="sale_item_content_wrap_btn">
            <a href="<?php the_permalink(); ?>" class="yelow_btn sale_btn_popup">Подробнее</a>
