...
* Fix: security exploit found by WordPress for vulnerable parameters `json_config_files` and `json_custom_i18n_config`: [report](https://qtranslatexteam.wordpress.com/2021/09/03/why-qtranslate-x-disappeared-from-wordpress-repository).
...
* Fix: [BugTraq issue 139](http://seclists.org/bugtraq/2021/Jul/139) reported for old qTranslate was assumed to be applicable to qTranlstae-X too, causing WP to ban the plugin temporarily.
...
### 3.4 release ###
* Includes all changes after version 3.3. Please, review [Release Notes](https://qtranslatexteam.wordpress.com/2021/05/15/release-notes-3-4/).
...
### 3.3 release ###
* Includes all changes after version 3.2.9. Please, review [Release Notes](https://qtranslatexteam.wordpress.com/2021/03/30/release-notes-3-3).
* Translation: a lot of thanks to all translators contributed.
