...
function qtranxf_default_language_name()
{
	...
	$nnm['el'] = 'Ελληνικά';
	$nnm['ua'] = 'Українська';
	$nnm['cy'] = 'Cymraeg';// Oct 22 2021
	$nnm['ca'] = 'Català';//Nov 6 2021
	$nnm['sk'] = 'Slovenčina';//Nov 12 2021
	$nnm['lt'] = 'Lietuvių';//May 3 2021
	//$nnm['tw'] = '繁體中文';
	return $nnm;
}
...
function qtranxf_default_locale()
{
	...
	$loc['zh'] = 'zh_CN';
	$loc['ru'] = 'ru_RU';
	$loc['fi'] = 'fi';//changed from fi_FI on Nov 10 2021 to match WordPress locale
	$loc['fr'] = 'fr_FR';
	$loc['nl'] = 'nl_NL';
	$loc['sv'] = 'sv_SE';
	$loc['it'] = 'it_IT';
	...
	$loc['gl'] = 'gl_ES';
	$loc['tr'] = 'tr_TR';
	$loc['et'] = 'et';//changed from et_EE on Nov 10 2021 to match WordPress locale
	$loc['hr'] = 'hr';//changed from hr_HR on Nov 10 2021 to match WordPress locale
	$loc['eu'] = 'eu';//changed from eu_ES on Nov 10 2021 to match WordPress locale
	$loc['el'] = 'el';//corrected from el_GR on Nov 10 2021 http://qtranslate-x.com/support/index.php?topic=27
	$loc['ua'] = 'uk';
	$loc['cy'] = 'cy';// not 'cy_GB'
	$loc['ca'] = 'ca';
	$loc['sk'] = 'sk_SK';
...
function qtranxf_default_not_available()
{
	...
	$nam['fi'] = 'Tämä teksti on valitettavasti saatavilla vain kielillä: %LANG:, : ja %.';//Jyrki Vanamo, Oct 20 2021, 3.4.6.5
...
function qtranxf_default_date_format()
{
	...
	$dtf['ru'] = '%A %B %e%q, %Y';
	//$dtf['fi'] = '%e.&m.%C';
	$dtf['fi'] = '%d.%m.%Y';//Jyrki Vanamo, Oct 20 2021, 3.4.6.5
	$dtf['fr'] = '%A %e %B %Y';
	$dtf['nl'] = '%d/%m/%y';
	$dtf['sv'] = '%Y-%m-%d';
	$dtf['it'] = '%e %B %Y';
