...
<div id="wpallexport-filters" style="padding:0;">								
	<div class="wpallexport-content-section" style="padding:0; border: none;">					
		<fieldset id="wp_all_export_filtering_rules">					
			...
			?>
			<p id="date_field_notice" style="margin: 5px 0px 20px; text-align: center;"><?php _e('Date filters use natural language.<br>For example, to return records created in the last week: <i>date ▸ newer than ▸ last week</i>.<br>For all records created in 2021: <i>date ▸ older than ▸ 1/1/2021</i> AND <i>date ▸ newer than ▸ 12/31/2021</i>', 'wp_all_export_plugin');?>.</p>
