...
class Jetpack_Slideshow_Shortcode {
	...
	function enqueue_scripts() {
		...
		wp_enqueue_script( 'jquery-cycle', plugins_url( '/js/jquery.cycle.min.js', __FILE__ ), array( 'jquery' ), '20211231', true );
		wp_enqueue_script( 'jetpack-slideshow', plugins_url( '/js/slideshow-shortcode.js', __FILE__ ), array( 'jquery-cycle' ), '20210119.1', true );
		if ( is_rtl() ) {
