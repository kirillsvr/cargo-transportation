...
if ( ! class_exists( 'Jetpack_Contact_Info_Widget' ) ) {
	...
	class Jetpack_Contact_Info_Widget extends WP_Widget {
		...
		public function enqueue_scripts() {
			wp_enqueue_style( 'contact-info-map-css', plugins_url( 'contact-info/contact-info-map.css', __FILE__ ), null, 20210623 );
		}
		...
		function form( $instance ) {
			$instance = wp_parse_args( $instance, $this->defaults() );
			wp_enqueue_script( 'contact-info-admin', plugins_url( 'contact-info/contact-info-admin.js', __FILE__ ), array( 'jquery' ), 20210727 );
