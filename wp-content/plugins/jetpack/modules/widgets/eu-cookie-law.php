...
if ( ! class_exists( 'Jetpack_EU_Cookie_Law_Widget' ) ) {
	...
	class Jetpack_EU_Cookie_Law_Widget extends WP_Widget {
		...
		function enqueue_frontend_scripts() {
			wp_enqueue_style( 'eu-cookie-law-style', plugins_url( 'eu-cookie-law/style.css', __FILE__ ), array(), '20210403' );
			wp_enqueue_script( 'eu-cookie-law-script', plugins_url( 'eu-cookie-law/eu-cookie-law.js', __FILE__ ), array( 'jquery' ), '20210404', true );
		}
